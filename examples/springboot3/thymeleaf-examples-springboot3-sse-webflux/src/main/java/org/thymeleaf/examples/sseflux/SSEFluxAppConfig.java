 ...
 * =============================================================================
 */
package org.thymeleaf.examples.sseflux;
...
@Configuration
public class SSEFluxAppConfig implements ApplicationContextAware {

    private static final Logger logger = LoggerFactory.getLogger(SSEFluxAppConfig.class);


    private ApplicationContext applicationContext;


    public SSEFluxAppConfig() {
        super();
    }
