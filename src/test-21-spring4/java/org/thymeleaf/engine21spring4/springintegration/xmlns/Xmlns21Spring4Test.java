 ...
 * =============================================================================
 */
package org.thymeleaf.engine21spring4.springintegration.xmlns;
...
public class Xmlns21Spring4Test {


    public Xmlns21Spring4Test() {
        super();
    }
    ...
    public void testXmlNs() throws Exception {
        ...
        executor.execute("classpath:engine21spring4/springintegration/xmlns");
