 ...
 * =============================================================================
 */
package org.thymeleaf.engine21.escaping;
...
public class Escaping21Test {


    public Escaping21Test() {
        super();
    }
    ...
    public void testEscaping() throws Exception {
        ...
        contextBuilder.setApplicationContextConfigLocation("classpath:engine21/escaping/applicationContext.xml");
        ...
        executor.execute("classpath:engine21/escaping");
