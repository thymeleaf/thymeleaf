...
public final class SpringResourceResourceResolverTest {
    ...
    public void testGetResourceAsStream() throws Exception {
        ...
        final String expected =
                ResourceUtils.read(
                        ClassLoaderUtils.getClassLoader(SpringResourceResourceResolverTest.class).getResourceAsStream(templateLocation),
                        "US-ASCII", true);
