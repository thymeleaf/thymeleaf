...
public interface IMessageResolver {
     ...
     * @param templateResolution the result of resolving the processed template
    ...
    public MessageResolution resolveMessage(
            final Arguments arguments, final TemplateResolution templateResolution, final String key, final Object[] messageParameters);
