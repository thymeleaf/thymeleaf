...
public interface ITemplateResolver {
     ...
     * </p>
     * <p>
     *   The <tt>arguments</tt> parameter contains all the info needed for trying to
     ...
     * </p>
     * 
     * @param arguments the arguments containing the info to resolve the template
     * @return a TemplateResolution object containing (maybe valid) resource resolution
     *         info for the template, or null.
     */
    /*
     * Arguments are resolved by String name (arguments.getTemplateName())
