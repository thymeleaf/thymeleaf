...
import org.thymeleaf.standard.processor.attr.StandardSingleNonRemovableConvertedAttributeModifierAttrProcessor;
import org.thymeleaf.standard.processor.attr.StandardSingleRemovableAttributeModifierAttrProcessor;
import org.thymeleaf.standard.processor.attr.StandardSingleRemovableConvertedAttributeModifierAttrProcessor;
...
public class StandardDialect extends AbstractXHTMLEnabledDialect {
    ...
    public static Set<IProcessor> createStandardProcessorsSet() {
        ...
        processors.addAll(Arrays.asList(StandardSingleNonRemovableConvertedAttributeModifierAttrProcessor.PROCESSORS));
        processors.addAll(Arrays.asList(StandardSingleRemovableAttributeModifierAttrProcessor.PROCESSORS));
        processors.addAll(Arrays.asList(StandardSingleRemovableConvertedAttributeModifierAttrProcessor.PROCESSORS));
