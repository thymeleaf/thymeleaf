...
public final class StandardFragmentTagProcessor extends AbstractElementTagProcessor {
    ...
    public StandardFragmentTagProcessor(final IProcessorDialect dialect, final TemplateMode templateMode, final String dialectPrefix) {
        super(dialect, templateMode, dialectPrefix, null, false, ATTR_NAME, true, PRECEDENCE);
    }
