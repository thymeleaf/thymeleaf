...
public abstract class AbstractStandardConditionalFixedValueAttrProcessor 
    ...
    public AbstractStandardConditionalFixedValueAttrProcessor() {
        super();
    }
    ...
    @Override
    protected final boolean isVisible(final Arguments arguments, final TemplateResolution templateResolution, final Document document,
            final Element element, final Attr attribute, final String attributeName, final String attributeValue) {
        
        final Object value = StandardExpressionProcessor.processExpression(arguments, templateResolution, attributeValue);
