...
public final class GreaterThanExpression extends GreaterLesserExpression {
    ...
    GreaterThanExpression(final Expression left, final Expression right) {
        super(left, right);
    }
    ...
    static Object executeGreaterThan(final Arguments arguments, final TemplateResolution templateResolution, 
            final GreaterThanExpression expression, final IStandardExpressionEvaluator expressionEvaluator) {
