...
public final class DivisionExpression extends MultiplicationDivisionRemainderExpression {
    ...
    static Object executeDivision(final Arguments arguments, final TemplateResolution templateResolution, 
            final DivisionExpression expression, final IStandardExpressionEvaluator expressionEvaluator) {
