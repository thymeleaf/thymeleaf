...
public final class StandardExpressionParser {
    ...
    public Expression parseExpression(final Arguments arguments, final TemplateResolution templateResolution, final String input) {
        Validate.notNull(arguments, "Arguments cannot be null");
        Validate.notNull(templateResolution, "Template Resolution cannot be null");
        Validate.notNull(input, "Input cannot be null");
        return parseExpression(arguments, templateResolution, input, true);
    }

    
    
    public AssignationSequence parseAssignationSequence(final Arguments arguments, final TemplateResolution templateResolution, final String input) {
        Validate.notNull(arguments, "Arguments cannot be null");
        Validate.notNull(templateResolution, "Template Resolution cannot be null");
        Validate.notNull(input, "Input cannot be null");
        return parseAssignationSequence(arguments, templateResolution, input, true);
    }

    
    
    public ExpressionSequence parseExpressionSequence(final Arguments arguments, final TemplateResolution templateResolution, final String input) {
        Validate.notNull(arguments, "Arguments cannot be null");
        Validate.notNull(templateResolution, "Template Resolution cannot be null");
        Validate.notNull(input, "Input cannot be null");
        return parseExpressionSequence(arguments, templateResolution, input, true);
    }

    
    
    public Each parseEach(final Arguments arguments, final TemplateResolution templateResolution, final String input) {
        Validate.notNull(arguments, "Arguments cannot be null");
        Validate.notNull(templateResolution, "Template Resolution cannot be null");
        Validate.notNull(input, "Input cannot be null");
        return parseEach(arguments, templateResolution, input, true);
    }
    

    
    public FragmentSelection parseFragmentSelection(final Arguments arguments, final TemplateResolution templateResolution, final String input) {
        Validate.notNull(arguments, "Arguments cannot be null");
        Validate.notNull(templateResolution, "Template Resolution cannot be null");
        Validate.notNull(input, "Input cannot be null");
        return parseFragmentSelection(arguments, templateResolution, input, true);
    }
    ...
    Expression parseExpression(final Arguments arguments, final TemplateResolution templateResolution, final String input, final boolean preprocess) {
        
        final String trimmedInput = input.trim();
        
        final String preprocessedInput =
            (preprocess?
                    preprocess(arguments, templateResolution, trimmedInput) :
                    trimmedInput);
    ...
    AssignationSequence parseAssignationSequence(final Arguments arguments, final TemplateResolution templateResolution, final String input, final boolean preprocess) {
    ...
    ExpressionSequence parseExpressionSequence(final Arguments arguments, final TemplateResolution templateResolution, final String input, final boolean preprocess) {
    ...
    Each parseEach(final Arguments arguments, final TemplateResolution templateResolution, final String input, final boolean preprocess) {
    ...
    FragmentSelection parseFragmentSelection(final Arguments arguments, final TemplateResolution templateResolution, final String input, final boolean preprocess) {
    ...
    String preprocess(final Arguments arguments, final TemplateResolution templateResolution, final String input) {
        ...
        if (matcher.find()) {
            ...
            do {
                ...
                final Expression expression = 
                    parseExpression(
                            arguments, templateResolution, matcher.group(1), false);
                if (expression == null) {
                    return null;
                }
                
                final Object result =
                    this.executor.executeExpression(arguments, templateResolution, expression);
