...
public final class DefaultExpression extends ComplexExpression {
    ...
    static Object executeDefault(final Arguments arguments, final TemplateResolution templateResolution, 
            final DefaultExpression expression, final IStandardExpressionEvaluator expressionEvaluator) {
        ...
        final Object queriedValue = 
            Expression.execute(arguments, templateResolution, expression.getQueriedExpression(), expressionEvaluator);
        
        if (queriedValue == null) {
            return Expression.execute(arguments, templateResolution, expression.getDefaultExpression(), expressionEvaluator);
        }
        return queriedValue;
