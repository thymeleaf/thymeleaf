...
public final class RemainderExpression extends MultiplicationDivisionRemainderExpression {
    ...
    static Object executeRemainder(final Arguments arguments, final TemplateResolution templateResolution, 
            final RemainderExpression expression, final IStandardExpressionEvaluator expressionEvaluator) {
