...
public final class LessOrEqualToExpression extends GreaterLesserExpression {
    ...
    static Object executeLessOrEqualTo(final Arguments arguments, final TemplateResolution templateResolution, 
            final LessOrEqualToExpression expression, final IStandardExpressionEvaluator expressionEvaluator) {
