...
public final class VariableExpression extends SimpleExpression {
    ...
    static Object executeVariable(
            ...
            final VariableExpression expression, final IStandardExpressionEvaluator expressionEvaluator) {
        ...
        final Object evaluationRoot = arguments.getExpressionEvaluationRoot();
        
        return expressionEvaluator.evaluate(arguments, templateResolution, exp, evaluationRoot);
