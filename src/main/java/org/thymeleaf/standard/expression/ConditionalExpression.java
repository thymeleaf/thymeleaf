...
public final class ConditionalExpression extends ComplexExpression {
    ...
    static Object executeConditional(final Arguments arguments, final TemplateResolution templateResolution, 
            final ConditionalExpression expression, final IStandardExpressionEvaluator expressionEvaluator) {
        ...
        final Object condObj = 
            Expression.execute(arguments, templateResolution, expression.getConditionExpression(), expressionEvaluator);
        final boolean cond = ObjectUtils.evaluateAsBoolean(condObj);
        
        if (cond) {
            return Expression.execute(arguments, templateResolution, expression.getThenExpression(), expressionEvaluator);
        }
        return Expression.execute(arguments, templateResolution, expression.getElseExpression(), expressionEvaluator);
