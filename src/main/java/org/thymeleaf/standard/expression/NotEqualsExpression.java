...
public final class NotEqualsExpression extends EqualsNotEqualsExpression {
    ...
    static Object executeNotEquals(final Arguments arguments, final TemplateResolution templateResolution, 
            final NotEqualsExpression expression, final IStandardExpressionEvaluator expressionEvaluator) {
