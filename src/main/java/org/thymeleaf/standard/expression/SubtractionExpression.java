...
public final class SubtractionExpression extends AdditionSubtractionExpression {
    ...
    static Object executeSubtraction(final Arguments arguments, final TemplateResolution templateResolution, 
            final SubtractionExpression expression, final IStandardExpressionEvaluator expressionEvaluator) {
