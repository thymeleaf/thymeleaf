...
public final class MinusExpression extends ComplexExpression {
    ...
    static Object executeMinus(final Arguments arguments, final TemplateResolution templateResolution, 
            final MinusExpression expression, final IStandardExpressionEvaluator expressionEvaluator) {
