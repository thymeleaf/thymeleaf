...
public final class Arguments {
     ...
     * @param selectionTarget the selection target
     * @param idCounts the map of ID counts
     * @param textInliner the text inliner (if any, can be null)
     */
    public Arguments(
            final Configuration configuration,
            final TemplateParser templateParser,
     ...
     * 
     * @since 1.1.3
     * @param templateResolution the template resolution for the current template being executed
     * @return the map of variables (a new object)
     */
    public Map<String,Object> computeBaseContextVariables(final TemplateResolution templateResolution) {
        final Map<String,Object> variables = new HashMap<String, Object>();
        variables.putAll(this.baseContextVariables);
        variables.putAll(ExpressionEvaluatorObjects.computeEvaluationVariablesForTemplateResolution(this, templateResolution));
        return variables;
    }
    ...
    public Arguments addLocalVariables(final Map<String,Object> newVariables) {
        ...
        final Arguments arguments = 
            new Arguments(this.configuration, this.templateParser, this.templateName, this.context, Collections.unmodifiableMap(cloneLocalVariables), this.selectionTarget, this.idCounts, this.textInliner);
        return arguments;
    }
    ...
    public Arguments setSelectionTarget(final Object target) {
        final Arguments arguments = 
            new Arguments(this.configuration, this.templateParser, this.templateName, this.context, this.localVariables, new SelectionTarget(target), this.idCounts, this.textInliner);
        return arguments;
    }
    ...
    public Arguments addLocalVariablesAndSetSelectionTarget(final Map<String,Object> newVariables, final Object target) {
        ...
        cloneLocalVariables.putAll(newVariables);
        final Arguments arguments = 
            new Arguments(this.configuration, this.templateParser, this.templateName, this.context, Collections.unmodifiableMap(cloneLocalVariables), new SelectionTarget(target), this.idCounts, this.textInliner);
        return arguments;
    }
    ...
    public Arguments setTextInliner(final ITextInliner newTextInliner) {
        final Arguments arguments = 
            new Arguments(this.configuration, this.templateParser, this.templateName, this.context, this.localVariables, this.selectionTarget, this.idCounts, newTextInliner);
        return arguments;
    }
    ...
    public Arguments addLocalVariablesAndTextInliner(final Map<String,Object> newVariables, final ITextInliner newTextInliner) {
        ...
        cloneLocalVariables.putAll(newVariables);
        final Arguments arguments = 
            new Arguments(this.configuration, this.templateParser, this.templateName, this.context, Collections.unmodifiableMap(cloneLocalVariables), this.selectionTarget, this.idCounts, newTextInliner);
        return arguments;
    }
    ...
    public Arguments setTextInlinerAndSetSelectionTarget(final ITextInliner newTextInliner, final Object target) {
        final Arguments arguments = 
            new Arguments(this.configuration, this.templateParser, this.templateName, this.context, this.localVariables, new SelectionTarget(target), this.idCounts, newTextInliner);
        return arguments;
    }
    ...
    public Arguments addLocalVariablesAndTextInlinerAndSetSelectionTarget(final Map<String,Object> newVariables, final ITextInliner newTextInliner, final Object target) {
        ...
        cloneLocalVariables.putAll(newVariables);
        final Arguments arguments = 
            new Arguments(this.configuration, this.templateParser, this.templateName, this.context, Collections.unmodifiableMap(cloneLocalVariables), new SelectionTarget(target), this.idCounts, newTextInliner);
        return arguments;
    }
