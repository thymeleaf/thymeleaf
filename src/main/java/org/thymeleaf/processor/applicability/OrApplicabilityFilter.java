 ...
 *
 */
public final class OrApplicabilityFilter implements IApplicabilityFilter {
    ...
    public OrApplicabilityFilter(final IApplicabilityFilter one, final IApplicabilityFilter two, final IApplicabilityFilter... other) {
        super();
