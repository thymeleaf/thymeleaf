 ...
 *
 */
public final class AttrExistsApplicabilityFilter implements IApplicabilityFilter {
    
    private final String attrName;
    
    
    public AttrExistsApplicabilityFilter(final String attrName) {
        super();
    ...
    public boolean isApplicableToTag(final Element element) {
        final Attr attribute = DOMUtils.findAttribute(this.attrName, element);
