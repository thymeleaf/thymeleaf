...
/**
 * <p>
 *   Base convenience implementation of {@link IAttrProcessor} returning empty
 ...
 * </p>
 * <p>
 *   This class provides a more convenient extension point for attribute processors,
...
public abstract class AbstractAttrProcessor 
    ...
    public int compareTo(final IAttrProcessor o) {
        if (o == null) {
            return 1;
        }
        final Integer precedence = getPrecedence();
        if (precedence == null) {
            return 1;
        }
