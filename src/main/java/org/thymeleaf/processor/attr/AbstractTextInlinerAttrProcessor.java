...
public abstract class AbstractTextInlinerAttrProcessor 
    ...
    public AbstractTextInlinerAttrProcessor() {
        super();
    }
    ...
    public final AttrProcessResult process(
        ...
        final ITextInliner textInliner = 
            getTextInliner(arguments, templateResolution, document, element, attribute, normalizedAttributeName, attributeValue);
        
        DOMExecution.clearExecutabilityFlags(element);
        
        return AttrProcessResult.forRemoveAttribute(textInliner);
