 ...
 *   <tt>HttpServletResponse#getWriter()</tt> writer in most web applications). This avoids the need to generate
 *   a large number of (possibly large) <tt>String</tt> object in memory before these values being output.
 * </p>
 *
