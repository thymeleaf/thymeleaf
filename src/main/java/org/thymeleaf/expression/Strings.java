...
public final class Strings {
	 ...
	 * @return the result of calling <tt>target.toString()</tt> if target is not
	 *         null, <tt>null</tt> if target is null.
	 * @since 2.0.12
	 */
	...
	/**
	 * <p>
	 * Performs a null-safe <tt>toString()</tt> operation on each element of the
	 * array.
	 * </p>
	 * 
	 * @param target
	 *            the array of objects on which toString will be executed
	 * @return for each element: the result of calling
	 *         <tt>target.toString()</tt> if target is not null, <tt>null</tt>
	 *         if target is null.
	 * @since 2.0.12
	 */
	...
	public List<Boolean> listContains(final List<?> target,
	...
	public Boolean[] arrayContainsIgnoreCase(final Object[] target,
			final String fragment) {
		Validate.notNull(target, "Target cannot be null");
		final Boolean[] result = new Boolean[target.length];
		for (int i = 0; i < target.length; i++) {
	...
	public List<Boolean> listContainsIgnoreCase(final List<?> target,
			final String fragment) {
		Validate.notNull(target, "Target cannot be null");
		final List<Boolean> result = new ArrayList<Boolean>();
		for (final Object element : target) {
	...
	public Set<Boolean> setContainsIgnoreCase(final Set<?> target,
			final String fragment) {
		Validate.notNull(target, "Target cannot be null");
		final Set<Boolean> result = new LinkedHashSet<Boolean>();
		for (final Object element : target) {
	...
	public List<Boolean> listStartsWith(final List<?> target,
			final String prefix) {
		Validate.notNull(target, "Target cannot be null");
		final List<Boolean> result = new ArrayList<Boolean>();
		for (final Object element : target) {
	...
	/**
	 * <p>
	 * copy a part of target start beginIndex to the end of target. If
	 * non-String object, toString() will be called.
	 * </p>
	 * 
	 * @param target
	 *            source of the copy.
	...
	/**
	 * <p>
	 * copy a part of target start beginIndex to the end of target for all the
	 * elements in the target array. If non-String object, toString() will be
	 * called.
	 * </p>
	 * 
	 * @param target
	 ...
	 * <p>
	 * copy a part of target start beginIndex to the end of target for all the
	 * elements in the target list. If non-String object, toString() will be
	 * called.
	 * </p>
	 * 
	 * @param target
	 ...
	 * <p>
	 * copy a part of target start beginIndex to the end of target for all the
	 * elements in the target set. If non-String object, toString() will be
	 * called.
	 * </p>
	 * 
	 * @param target
	...
	public String[] arraySubstringAfter(final Object[] target,
			final String substr) {
		Validate.notNull(target, "Target cannot be null");
		final String[] result = new String[target.length];
		for (int i = 0; i < target.length; i++) {
	...
	public List<String> listSubstringAfter(final List<?> target,
			final String substr) {
		Validate.notNull(target, "Target cannot be null");
		final List<String> result = new ArrayList<String>();
		for (final Object element : target) {
	...
	public Set<String> setSubstringAfter(final Set<?> target,
			final String substr) {
		Validate.notNull(target, "Target cannot be null");
		final Set<String> result = new LinkedHashSet<String>();
		for (final Object element : target) {
	...
	public String[] arraySubstringBefore(final Object[] target,
			final String substr) {
		Validate.notNull(target, "Target cannot be null");
		final String[] result = new String[target.length];
		for (int i = 0; i < target.length; i++) {
	...
	public List<String> listSubstringBefore(final List<?> target,
			final String substr) {
		Validate.notNull(target, "Target cannot be null");
		final List<String> result = new ArrayList<String>();
		for (final Object element : target) {
	...
	public Set<String> setSubstringBefore(final Set<?> target,
			final String substr) {
		Validate.notNull(target, "Target cannot be null");
		final Set<String> result = new LinkedHashSet<String>();
		for (final Object element : target) {
	 ...
	 * @since 2.0.16
	 */
	public String concatReplaceNulls(final String nullValue,
			final Object... values) {
	...
	public List<String> listSplit(final Object target, final String separator) {
		return new ArrayList<String>(java.util.Arrays.asList(StringUtils.split(
				target, separator)));
	}

	public Set<String> setSplit(final Object target, final String separator) {
		return new LinkedHashSet<String>(java.util.Arrays.asList(StringUtils
				.split(target, separator)));
	}
	...
	public String replace(final Object target, final String before,
			final String after) {
	...
	public String[] arrayReplace(final Object[] target, final String before,
			final String after) {
		Validate.notNull(target, "Target cannot be null");
		final String[] result = new String[target.length];
		for (int i = 0; i < target.length; i++) {
	...
	public List<String> listReplace(final List<?> target, final String before,
			final String after) {
		Validate.notNull(target, "Target cannot be null");
		final List<String> result = new ArrayList<String>();
		for (final Object element : target) {
	...
	public Set<String> setReplace(final Set<?> target, final String before,
			final String after) {
		Validate.notNull(target, "Target cannot be null");
		final Set<String> result = new LinkedHashSet<String>();
		for (final Object element : target) {
	...
	/**
	 * <p>
	 * Convert the first letter into uppercase (title-case, in fact) for all the
	 * elements in the target array.
	 * </p>
	 * 
	 * @param target
	 *            the array of Strings to be capitalized. If non-String objects,
	 *            toString() will be called.
	 * @return a String[] with the result of capitalizing each element of the
	 *         target.
	 * 
	 * @since 1.1.2
	 * 
	 ...
	 * 
	 * @param target
	 *            the list of Strings to be capitalized. If non-String objects,
	 *            toString() will be called.
	 * @return a List with the result of capitalizing each element of the
	 *         target.
	 * 
	 * @since 1.1.2
	 * 
	 ...
	 * 
	 * @param target
	 *            the set of Strings to be capitalized. If non-String objects,
	 *            toString() will be called.
	 ...
	 * 
	 * @param target
	 *            the String to be uncapitalized. If non-String object,
	 *            toString() will be called.
	 * 
	...
	/**
	 * <p>
	 * Convert the first letter into lowercase for all the elements in the
	 * target array.
	 * </p>
	 * 
	 * @param target
	 *            the array of Strings to be uncapitalized. If non-String
	 *            objects, toString() will be called.
	 * 
	 * @return a String[] with the result of uncapitalizing each element of the
	 *         target.
	 * 
	 * @since 1.1.2
	 * 
	 ...
	 * 
	 * @param target
	 *            the list of Strings to be uncapitalized. If non-String
	 *            objects, toString() will be called.
	 * 
	 * @return a List with the result of uncapitalizing each element of the
	 *         target.
	 * 
	 * @since 1.1.2
	 * 
	 ...
	 * 
	 * @param target
	 *            the set of Strings to be uncapitalized. If non-String objects,
	 *            toString() will be called.
	 * 
	 * @return a Set with the result of uncapitalizing each element of the
	 *         target.
	 * 
	 * @since 1.1.2
	 * 
	 ...
	 * (title-case, in fact). The default delimiter characters between the words
	 * are the whitespace characters (see Characters.IsWhiteSpace method in the
	 * Java documentation).
	 * </p>
	 * 
	 * @param target
	 ...
	 * <p>
	 * Convert the first letter of each words of target to uppercase
	 * (title-case, in fact) for all the elements in the target array. The
	 * default delimiter characters between the words are the whitespace
	 * characters (see Characters.IsWhiteSpace method in the Java
	 * documentation).
	 * </p>
	 * 
	 * @param target
	 ...
	 * <p>
	 * Convert the first letter of each words of target to uppercase
	 * (title-case, in fact) for all the elements in the target list. The
	 * default delimiter characters between the words are the whitespace
	 * characters (see Characters.IsWhiteSpace method in the Java
	 * documentation).
	 * </p>
	 ...
	 * <p>
	 * Convert the first letter of each words of target to uppercase
	 * (title-case, in fact) for all the elements in the target set. The default
	 * delimiter characters between the words are the whitespace characters (see
	 * Characters.IsWhiteSpace method in the Java documentation).
	 * </p>
	 * 
	 * @param target
	 *            the set of Strings to be capitalized. If non-String objects,
	 ...
	 * <p>
	 * Convert the first letter of each words of target to uppercase
	 * (title-case, in fact), using the specified delimiter chars for
	 * determining word ends/starts.
	 * </p>
	 * 
	 * @param target
	 *            the String to be capitalized. If non-String object, toString()
	 *            will be called.
	 * @param delimiters
	 *            the delimiters of the words. If non-String object, toString()
	 *            will be called.
	 * 
	 * @return String the result of capitalizing the target.
	 * 
	 ...
	 * 
	 */
	public String capitalizeWords(final Object target, final Object delimiters) {
	 ...
	 * Convert the first letter of each words of target to uppercase
	 * (title-case, in fact) for all the elements in the target array. The
	 * specified delimiter chars will be used for determining word ends/starts.
	 * </p>
	 * 
	 * @param target
	 *            the array of Strings to be capitalized. If non-String objects,
	 ...
	 * <p>
	 * Convert the first letter of each words of target to uppercase
	 * (title-case, in fact) for all the elements in the target set. The
	 * specified delimiter chars will be used for determining word ends/starts.
	 * </p>
	 * 
	 * @param target
	 ...
	 * 
	 * @param target
	 *            the array of Strings to be escaped. If non-String objects,
	 *            toString() will be called.
	 * 
	 * @return a String[] with the result of each each element of the target.
	 * 
	 * @since 2.0.9
	 * 
	 */
	 ...
	 * 
	 * @param target
	 *            the list of Strings to be escaped. If non-String objects,
	 *            toString() will be called.
	 * 
	 * @return a List with the result of each each element of the target.
	 * 
	 * @since 2.0.9
	 * 
	 */
	 ...
	 *            toString() will be called.
	 * 
	 * @return a Set with the result of each each element of the target.
	 * 
	 * @since 2.0.9
	 * 
	 */
	 ...
	 * 
	 * @param target
	 *            the array of Strings to be unescaped. If non-String objects,
	 *            toString() will be called.
	 * 
	 * @return a String[] with the result of each each element of the target.
	 * 
	 ...
	 * 
	 * @param target
	 *            the list of Strings to be unescaped. If non-String objects,
	 *            toString() will be called.
	 * 
	 * @return a List with the result of each each element of the target.
	 * 
