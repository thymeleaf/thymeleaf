...
public class Messages {
    ...
    public String msg(final String messageKey, final Object... messageParameters) {
        return MessageResolutionUtils.resolveMessageForTemplate(
                this.arguments, this.templateResolution, messageKey, messageParameters, true);
    }
    
    
    public String msgOrNull(final String messageKey, final Object... messageParameters) {
        return MessageResolutionUtils.resolveMessageForTemplate(
                this.arguments, this.templateResolution, messageKey, messageParameters, false);
    }
        ...
        for (int i = 0; i < messageKeys.length; i++) {
            result[i] = 
                MessageResolutionUtils.resolveMessageForTemplate(
                    this.arguments, this.templateResolution, (String)messageKeys[i], messageParameters, true);
        }
        return result;
    }
    ...
    public String[] arrayMsgOrNull(final Object[] messageKeys, final Object... messageParameters) {
        ...
        for (int i = 0; i < messageKeys.length; i++) {
            result[i] = 
                MessageResolutionUtils.resolveMessageForTemplate(
                    this.arguments, this.templateResolution, (String)messageKeys[i], messageParameters, false);
        }
        return result;
    }
    ...
    private List<String> doMsg(final boolean returnStringAlways, final Iterable<String> messageKeys, final Object... messageParameters) {
        ...
        for (final String messageKey : messageKeys) {
            result.add(
                    MessageResolutionUtils.resolveMessageForTemplate(
                        this.arguments, this.templateResolution, messageKey, messageParameters, returnStringAlways));
        }
        return result;
    }
    ...
    public Messages(final Arguments arguments, final TemplateResolution templateResolution) {
        super();
