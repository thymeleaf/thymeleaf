 ...
 *
 */
public final class MarkupSelector implements Serializable {
    ...
    private final MarkupSelector next;
     ...
     */
    public MarkupSelector(final String selectorExpression) {
        this(selectorExpression, true);
    }



    private MarkupSelector(final String selectorExpression, final boolean atRootLevel) {
        ...
        if (selEnd != -1) {
            ...
            this.next = new MarkupSelector(tail, false);
        } else {
            this.next = null;
        }
