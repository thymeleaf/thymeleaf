...
/**
 * <p>
 *    Defines the type of a parsable artifact.
 * </p>
 * <p>
 ...
 *    on which the template engine is executed, but instead intermediate artifacts that are parsed and/or processed
 *    during the processing of a complete template. Examples of fragments are <em>unescaped text</em> ,
 *    <em>inserted template fragments</em> or <em>inlined template fragments</em>.
 * </p>
 *
 ...
 * 
 */
public enum ParsableArtifactType {
