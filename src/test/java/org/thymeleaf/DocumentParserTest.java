...
import org.thymeleaf.dom.Root;
import org.thymeleaf.dom.Tag;
import org.thymeleaf.dom.parser.IDocumentParser;
import org.thymeleaf.dom.parser.XmlDomDocumentParser;
...
public class DocumentParserTest
{
    ...
    private IDocumentParser xmlDomDocumentParser;
    private IDocumentParser xmlSaxDocumentParser;
    ...
    public void initialize()
    {
        ...
        originalTemplateParser = new OriginalTemplateParser(configuration);
        
        StandardDOMTranslator converter =
            new StandardDOMTranslator();
        
        xmlDomDocumentParser = new XmlDomDocumentParser(configuration, 2, converter);
        xmlSaxDocumentParser = new XmlSaxDocumentParser(configuration, 2);
    }
    ...
    public void testLocation()
    {
        ...
        Document saxDoc = xmlSaxDocumentParser.parse(documentName, template, false);
        Document domDoc = xmlDomDocumentParser.parse(documentName, template, false);
